                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group{{ $errors->has('Nome') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="Nome" type="text" class="form-control" placeholder="Nome" value="{{ old('Nome') }}" required autofocus>
                                    @if ($errors->has('Nome'))
                                ...
                                <div class="form-check text-left">
                                    <label class="form-check-label">
                                        ...
                                        <span class="form-check-sign"></span>
                                            {{ __('Eu aceito os') }}
                                        <a href="#something">{{ __('termos de uso') }}</a>.
                                    </label>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Começar') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
